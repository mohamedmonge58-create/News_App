...
class NetworkRequestServices {
  ...
  static Future<List<Source>> getAllSources(String categoryID) async {
    final response = await http.get(
      Uri.https(NetworkConstant.baseUrl, EndPoints.allSources, {
  ...
  static Future<List<Artical>> getAllArticles(String sourceID) async {
    final response = await http.get(
      Uri.https(NetworkConstant.baseUrl, EndPoints.allArticles, {
        'apiKey': NetworkConstant.apiKey,
        'sources': sourceID,
      }),
    );
  ...
  static Future<List<Artical>> searchArticles(String query) async {
    final response = await http.get(
      Uri.https(NetworkConstant.baseUrl, EndPoints.searchArticles, {
        'apiKey': NetworkConstant.apiKey,
        'q': query,
        'sortBy': 'publishedAt',
      }),
